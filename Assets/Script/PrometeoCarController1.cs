...
public class PrometeoCarController1 : MonoBehaviour
{
    //CAR SETUP
    ...
    */
    ...
    [SerializeField] public StarterAssetsInputsOne _inputsOne;
    ...
    */
    ...
    void Update()
    {
        ...
        */
        ...
        {
            if ( /*Input.GetKey(KeyCode.W)*/ _inputsOne.Roll > 0.1f)
            {
                CancelInvoke("DecelerateCar");
                deceleratingCar = false;
                GoForward();
            ...
            if ( /*Input.GetKey(KeyCode.S)*/ _inputsOne.Roll < 0f)
            {
                CancelInvoke("DecelerateCar");
                deceleratingCar = false;
                GoReverse();
            ...
            if ( /*Input.GetKey(KeyCode.A)*/ _inputsOne.Turn < 0f)
            {
                TurnLeft();
            }

            if ( /*Input.GetKey(KeyCode.D)*/ _inputsOne.Turn > 0.1f)
            {
                TurnRight();
            }
            ...
            //     GetKeyUp = true;
            // }
            // else if (!_inputs.Handbrake && GetKeyUp)
            // {
            //     RecoverTraction();
            //     GetKeyUp = false;
            //     Debug.Log("Test");
            ...
            if ((!(_inputsOne.Roll < 0f) /*Input.GetKey(KeyCode.S)*/ &&
                 !(_inputsOne.Roll > 0.1f) /*Input.GetKey(KeyCode.W*/))
            {
                ThrottleOff();
            }

            if (( /*Input.GetKey(KeyCode.S)*/
                    !(_inputsOne.Roll < 0f) && /*Input.GetKey(KeyCode.W)*/!(_inputsOne.Roll > 0.1f)) &&
            ...
            if (!(_inputsOne.Turn < 0f) /*Input.GetKey(KeyCode.A)*/ &&
                !(_inputsOne.Turn > 0.1f) /*Input.GetKey(KeyCode.D)*/ && steeringAxis != 0f)
            {
                ResetSteeringAngle();
            }
        }
